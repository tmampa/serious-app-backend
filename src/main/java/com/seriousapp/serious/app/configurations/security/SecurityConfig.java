...
public class SecurityConfig {
    ...
    public SecurityConfig(@Lazy UserService userDetailsService,
                          @Lazy JWTFilter jwtAuthenticationFilter) {
...
//                        .requestMatchers("/api/student/**").hasRole("STUDENT")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000", "http://52.188.184.166:3000", "http://52.188.184.166:3000/**", "http://52.188.184.166:3000/"));
